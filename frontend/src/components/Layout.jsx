  ...
  return (
    <div className="page-wrap">
      ...
      <footer className="site-footer">
        ...
        <div className="footer-bot">© 2026 Baby Hub. All rights reserved.</div>
      </footer>

      <a href="https://wa.me/+94789299383" className="wa-btn" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
